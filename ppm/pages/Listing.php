...
<head>
    ...
    <title>Rooms - PG Management System</title>
            ...
            <div class='container'>
                <div class='navbar-container'>
                    ...
                    <ul class='navbar-nav'>
                        ...
                        <li><a href='#' class='nav-link active'>Rooms</a></li>
    ...
    <main class="container">
        <section class="section">
            <div class="search-section">
                <form class="search-form" action="Listing.php" method="GET">
                        ...
                        <div class="pg-card">
                            ...
                            <div class="pg-card-body">
                                ...
                                <div class="pg-card-actions">
                                    <a href="view_details.php?lid=<?php echo $listing['lid']; ?>" 
