...
<head>
    ...
    <title>User Login - PG Management System</title>
                ...
                <div style="background: white; padding: 2rem; border-radius: 0.5rem; box-shadow: 0 10px 15px -3px rgb(0 0 0 / 0.1);">
                    ...
                    <form action="login.php" method="post">
                        <div style="margin-bottom: 1.5rem;">
                            <label for="ulname" style="display: block; margin-bottom: 0.5rem; font-weight: 500;">
                            ...
                            <input type="text" 
                                   ...
                                   id="ulname" 
                                   required
                                   style="width: 100%; padding: 0.75rem; border: 1px solid var(--border-color); border-radius: 0.375rem; font-size: 1rem;">
                        </div>
                    ...
                    <div style="text-align: center; margin-top: 1.5rem;">
                        <p style="color: var(--text-secondary);">
                            ...
                            <a href="signup.php" style="color: var(--primary-color);">Sign up here</a>
                    </div>
                </div>
            </div>
        </section>
